...
\section{Елементи на онтологията}
    ...
    \subsection{Концепти}
        ...
        \textbf{DomainThing} $\sqsubseteq$ Thing \\ \tabularnewline
            ...
            \MyIndent \{\{Argentina\} $\cup$ (Argentina, Australia, China, Greece, India, Indonesia, Italy, New\_Zeland, Philippines, Spain, Turkey, United\_Kingdom, United\_States, Iran)] 
                      \\ \tabularnewline
        	\textbf{Food} \\
        		IceCream \\
        			Argentinian \\
